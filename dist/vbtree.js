...
var array_index = __webpack_require__(/*! ./array_index */ "./src/array_index.js");
var array_permutations = __webpack_require__(/*! ./array_permutations */ "./src/array_permutations.js");
var roots_flatten = __webpack_require__(/*! ./roots_flatten */ "./src/roots_flatten.js");
var tree_ancestors = __webpack_require__(/*! ./tree_ancestors */ "./src/tree_ancestors.js");
var tree_common_ancestor = __webpack_require__(/*! ./tree_common_ancestor */ "./src/tree_common_ancestor.js");
var tree_descendants = __webpack_require__(/*! ./tree_descendants */ "./src/tree_descendants.js");
var tree_diff = __webpack_require__(/*! ./tree_diff */ "./src/tree_diff.js");
var tree_find_shifts = __webpack_require__(/*! ./tree_find_shifts */ "./src/tree_find_shifts.js");
var tree_finder_make = __webpack_require__(/*! ./tree_finder_make */ "./src/tree_finder_make.js");
var tree_flatten = __webpack_require__(/*! ./tree_flatten */ "./src/tree_flatten.js");
var tree_from_array = __webpack_require__(/*! ./tree_from_array */ "./src/tree_from_array.js");
var tree_from_string = __webpack_require__(/*! ./tree_from_string */ "./src/tree_from_string.js");
var tree_insert = __webpack_require__(/*! ./tree_insert */ "./src/tree_insert.js");
var tree_intersect = __webpack_require__(/*! ./tree_intersect */ "./src/tree_intersect.js");
var tree_map_orig = __webpack_require__(/*! ./tree_map_orig */ "./src/tree_map_orig.js");
var tree_move = __webpack_require__(/*! ./tree_move */ "./src/tree_move.js");
var tree_move_after = __webpack_require__(/*! ./tree_move_after */ "./src/tree_move_after.js");
var tree_move_before = __webpack_require__(/*! ./tree_move_before */ "./src/tree_move_before.js");
var tree_move_into = __webpack_require__(/*! ./tree_move_into */ "./src/tree_move_into.js");
var tree_move_v2 = __webpack_require__(/*! ./tree_move_v2 */ "./src/tree_move_v2.js");
var tree_node_next = __webpack_require__(/*! ./tree_node_next */ "./src/tree_node_next.js");
var tree_node_prev = __webpack_require__(/*! ./tree_node_prev */ "./src/tree_node_prev.js");
var tree_pointer_shift = __webpack_require__(/*! ./tree_pointer_shift */ "./src/tree_pointer_shift.js");
var tree_print = __webpack_require__(/*! ./tree_print */ "./src/tree_print.js");
var tree_random = __webpack_require__(/*! ./tree_random */ "./src/tree_random.js");
var tree_resolve = __webpack_require__(/*! ./tree_resolve */ "./src/tree_resolve.js");
var tree_shift = __webpack_require__(/*! ./tree_shift */ "./src/tree_shift.js");
var tree_sort_preorder = __webpack_require__(/*! ./tree_sort_preorder */ "./src/tree_sort_preorder.js");
var tree_walk_preorder = __webpack_require__(/*! ./tree_walk_preorder */ "./src/tree_walk_preorder.js");
var tree_walk_preorder_prefix = __webpack_require__(/*! ./tree_walk_preorder_prefix */ "./src/tree_walk_preorder_prefix.js");
var tree_walk_preorder_rev = __webpack_require__(/*! ./tree_walk_preorder_rev */ "./src/tree_walk_preorder_rev.js");
module.exports = {
  array_index: array_index,
  array_permutations: array_permutations,
  roots_flatten: roots_flatten,
  tree_ancestors: tree_ancestors,
  tree_common_ancestor: tree_common_ancestor,
  tree_descendants: tree_descendants,
  tree_diff: tree_diff,
  tree_find_shifts: tree_find_shifts,
  tree_finder_make: tree_finder_make,
  tree_flatten: tree_flatten,
  tree_from_array: tree_from_array,
  tree_from_string: tree_from_string,
  tree_insert: tree_insert,
  tree_intersect: tree_intersect,
  tree_map_orig: tree_map_orig,
  tree_move: tree_move,
  tree_move_after: tree_move_after,
  tree_move_before: tree_move_before,
  tree_move_into: tree_move_into,
  tree_move_v2: tree_move_v2,
  tree_node_next: tree_node_next,
  tree_node_prev: tree_node_prev,
  tree_pointer_shift: tree_pointer_shift,
  tree_print: tree_print,
  tree_random: tree_random,
  tree_resolve: tree_resolve,
  tree_shift: tree_shift,
  tree_sort_preorder: tree_sort_preorder,
  tree_walk_preorder: tree_walk_preorder,
  tree_walk_preorder_prefix: tree_walk_preorder_prefix,
  tree_walk_preorder_rev: tree_walk_preorder_rev
};
...
function tree_ancestors(nodes, target) {
  var tree = tree_from_array(nodes.map(tree_map_orig));
  var out = [];
...
function tree_descendants(nodes, selection) {
  var dump = 0;
  var descendants = [];
  var selection_map = array_index(selection, function (v) {
    return v.id;
  });
  tree_walk_preorder({
...
function update(ctx, x, y) {
  ...
  var tmp = tree_pointer_shift(ctx.nodes, ctx.selection_map, i, shift, ctx.is_shift_allowed);
  ctx.i = tmp.i;
...
function tree_from_array() {
  ...
  for (var _i = 0, _end = orphans.length; _i < _end; ++_i) {
    ...
    if (_node.parent) {
      ...
      _node.siblings = _node.parent.children;
...
function tree_move(nodes, selection, i, parent_id) {
  var subsel = tree_intersect(nodes, selection);
  var subsel_ids = array_index(subsel, function (v) {
    return v.id;
  });
...
module.exports = tree_move_before;
...
function tree_print(_ref) {
  ...
  return tree_walk_preorder({
    ...
    visit: function visit(ctx) {
      ctx.retval += tree_walk_preorder_prefix(ctx).map(function (v) {
        return prefix4[v];
...
function tree_resolve(nodes, start, one_down, horizontal_shift) {
  ...
  var nodes_map = array_index(nodes, function (v) {
    return v.id;
  });
  var _tree_from_array = tree_from_array(nodes.map(function (node, i) {
      return {
        id: node.id,
...
module.exports = tree_walk_preorder_rev;
